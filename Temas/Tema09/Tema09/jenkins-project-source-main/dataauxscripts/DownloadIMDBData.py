...
def download_data():
    ...
    logging.info('Starting download: ' + FILE_NM_NAME_BASICS)
    ...
    logging.info('Starting download: ' + FILE_NM_TITLE_BASICS)
    ...
    logging.info('Starting download: ' + FILE_NM_TITLE_PRINCIPALS)
