...
PATH_DATA_TWITTER = "data/twitterdata/"
PATH_DATA_IMDB_ORIG = "data/imdbdata/original/"
PATH_DATA_IMDB_TRANS = "data/imdbdata/transformed/"


def create_data_dir_tree():
    if not os.path.isdir(PATH_DATA_IMDB_ORIG):
        os.makedirs(PATH_DATA_IMDB_ORIG)
    if not os.path.isdir(PATH_DATA_IMDB_TRANS):
        os.makedirs(PATH_DATA_IMDB_TRANS)
    if not os.path.isdir(PATH_DATA_TWITTER):
        os.makedirs(PATH_DATA_TWITTER)
...
if __name__ == '__main__':
    ...
    fields_csv_log = ['name', 'tweet', 'date']
